...
> Example Crystal codebase that adheres to the [RealWorld](https://realworld.io) API spec.

Welcome to the Crystal World, a [RealWorld](https://realworld.io) back-end application written in [Crystal](https://crystal-lang.org)!

## About

This project is aimed to demonstrate of how easy and enjoyable it is to develop a highly-perfomant web application in [Crystal](https://crystal-lang.org), which is proven to be both fast and beautiful language.
...
Crystal World uses [Prism web framework](https://github.com/vladfaust/prism) and [Core ORM](https://github.com/vladfaust/core.cr) as its foundation. The database chosen is PostgreSQL.
...
First of all, you'll need to [install Crystal Programming Language](https://crystal-lang.org/docs/installation/). Then clone this repository with `git clone https://github.com/vladfaust/crystalworld.git && cd crystalworld`.
